...
function draw()
{
	...
	if(officerPositionY < 749)
	{
		if(officerPositionX > 319)
		{
			officerDirectionY = 0;
			officerDirectionX = -1;
		}
    ...
    if(officerPositionY < 674)
        {
            officerDirectionX = -1; 
            officerDirectionY = 0;
        } 
    if(officerPositionX < 241) 
        {
            officerDirectionX = 0; 
            officerDirectionY = -1;
        } 
    if(officerPositionY < 602)
        {
            officerDirectionX = -1; 
            officerDirectionY = 0;
        }
    if(officerPositionX < 156)
        {
            officerDirectionX = 0; 
            officerDirectionY = -1;
        }
    if(officerPositionY < 496)
        {
            officerDirectionX = 1; 
            officerDirectionY = 0;  
            
            if(officerPositionX > 342)
            {
               officerDirectionX = 0; 
               officerDirectionY = -1; 
            }
    ...
    if(officerPositionY < 428) 
        {
            officerDirectionX = -1; 
            officerDirectionY = 0;
            
            if(officerPositionX < 217) 
                {
                    officerDirectionX = 0; 
                    officerDirectionY = -1;
                }
        }
    if(officerPositionY < 315)
        {
            officerDirectionX = 1; 
            officerDirectionY = 0;
            
            if(officerPositionX > 369)
              {
                  officerDirectionX = 0; 
                  officerDirectionY = -1;
              }
        }
    if(officerPositionY < 169)
        {
            officerDirectionX = 1; 
            officerDirectionY = 0;
            
            if(officerPositionX > 436)
                {
                    officerDirectionX = 0; 
                    officerDirectionY = -1;
                }
